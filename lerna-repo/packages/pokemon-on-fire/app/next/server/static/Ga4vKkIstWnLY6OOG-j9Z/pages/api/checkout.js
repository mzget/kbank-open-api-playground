...
/* harmony import */ var cross_fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("CCqr");
  ...
  switch (method) {
    case "POST":
      try {
        ...
        const resp = await Object(cross_fetch__WEBPACK_IMPORTED_MODULE_1__["fetch"])(url, {
          method: "POST",
          headers: {
        ...
        if (resp.ok) {
          ...
          const result = await resp.json();
          throw new Error(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(result));
        }
      } catch (ex) {
        res.status(400).json({
          status: "Bad Request",
